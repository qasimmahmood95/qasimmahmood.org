...
Single-page personal site for Qasim Mahmood — Senior SDET, regulated fintech & digital assets.
...
5. Custom domain: **Pages project → Custom domains → Set up a custom domain** → `qasimmahmood.org`. If the domain's DNS is already on Cloudflare this is a one-click CNAME; otherwise move the nameservers first.
